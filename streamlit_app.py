...
if (sidebarContent == "Semester Exam Report"):
    ...
    with(login):
        ...
        elif (textInput != "<table id=lju><tbody><td>SPI:</td><td> " + str(df["SPI"][tindex]) + "</td></tr><td>CPI:</td><td> " + str(df["CPI"][tindex]) + "</td></tr><td>CGPA:</td><td> " + str(df["CGPA"][tindex]) + "</td></tr><td>Status:</td><td> " + str(df["Status"][tindex]) + "</td></tr><td>Current Backlog:</td><td> " + str(df["CurrentBacklog"][tindex]) + "td></tr><td>Total Backlog:</td><td> " + str(df["TotalBacklog"][tindex]) + "td></tr><td>Declaration Date:</td><td> " + str(df["DeclarationDate"][tindex]) + "td></tr></tbody></table>" and status == False):
